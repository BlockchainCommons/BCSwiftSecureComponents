...
class EncryptedMessageTests: XCTestCase {
    ...
    func testCBOR() {
        ...
        XCTAssertEqual(encryptedMessage.cbor.diagnostic(annotate: true, knownTags: knownTags),
        """
        205(   ; encrypted
           [
        ...
        XCTAssertEqual(encryptedMessage.cbor.hex(annotate: true, knownTags: knownTags),
        """
...
//        print(encryptedMessage.ur)
        ...
        XCTAssertEqual(encryptedMessage.ur, expectedUR)
    }
}
