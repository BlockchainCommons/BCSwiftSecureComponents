...
//         print(privateKeys.agreementPrivateKey.publicKey.data.hex)
        ...
        XCTAssertEqual(privateKeys.signingPrivateKey.secp256k1SchnorrPublicKey.data, ‡"fd4d22f9e8493da52d730aa402ac9e661deca099ef4db5503f519a73c3493e18")
        XCTAssertEqual(privateKeys.x25519AgreementPrivateKey.data, ‡"77ff838285a0403d3618aa8c30491f99f55221be0b944f50bfb371f43b897485")
        XCTAssertEqual(privateKeys.x25519AgreementPrivateKey.publicKey.data, ‡"863cf3facee3ba45dc54e5eedecb21d791d64adfb0a1c63bfb6fea366c1ee62b")
